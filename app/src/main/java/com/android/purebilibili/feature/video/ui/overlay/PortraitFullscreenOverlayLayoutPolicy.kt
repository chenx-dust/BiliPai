...
data class PortraitFullscreenOverlayLayoutPolicy(
    ...
    val bottomTextScrimHeightDp: Int,
    val bottomTextScrimEndAlpha: Float,
...
fun resolvePortraitFullscreenOverlayLayoutPolicy(
    ...
    if (widthDp >= 1600) {
        return PortraitFullscreenOverlayLayoutPolicy(
            ...
            topScrimStartAlpha = 0.42f,
            bottomTextScrimHeightDp = 440,
            bottomTextScrimEndAlpha = 0.68f,
    ...
    if (widthDp >= 840) {
        return PortraitFullscreenOverlayLayoutPolicy(
            ...
            bottomInputLiftDp = 5,
            topScrimHeightDp = 148,
            topScrimStartAlpha = 0.42f,
            bottomTextScrimHeightDp = 372,
            bottomTextScrimEndAlpha = 0.68f,
    ...
    if (widthDp >= 600) {
        return PortraitFullscreenOverlayLayoutPolicy(
            ...
            bottomInputLiftDp = 4,
            topScrimHeightDp = 136,
            topScrimStartAlpha = 0.42f,
            bottomTextScrimHeightDp = 340,
            bottomTextScrimEndAlpha = 0.68f,
    ...
    return PortraitFullscreenOverlayLayoutPolicy(
        ...
        bottomInputLiftDp = 4,
        topScrimHeightDp = if (compact) 116 else 128,
        topScrimStartAlpha = 0.42f,
        bottomTextScrimHeightDp = if (compact) 300 else 320,
        bottomTextScrimEndAlpha = 0.68f,
